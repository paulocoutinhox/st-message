...
def message(message: Union[List[str], str], 
            ...
            is_audio: Optional[Union[bool, List[bool]]] = False,
    ...
    is_audio: bool or list
        if the message is an audio, if `True` will add an audio tag to the
        message, default is False.
    ...
    _streamlit_message(message=message, seed=seed, isUser=is_user, isPicture=is_picture, isAudio=is_audio, avatarStyle=avatar_style, key=key, answers=answers)
